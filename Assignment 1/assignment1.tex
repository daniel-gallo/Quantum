...
\begin{document}
    ...
    \end{equation*}
    Thus, if $(a, b) = (0, 0)$ or $(a, b) = (2, 1)$ the commutator vanishes.
    ...
    \begin{tcolorbox}[title=Exercise 5]
        ...
        \begin{enumerate}
            ...
            \item Sow that a positive operator on $\H$ has a unique positive square root. You may use the spectral theorem and the fact that a positive operator is necessarily Hermitian.
        \end{enumerate}
    \end{tcolorbox}
    \begin{enumerate}
        \item \begin{align*}
