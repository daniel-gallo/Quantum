...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \end{align*}
            \item If $j = k$ the equation holds because the Pauli matrices are idempotent ($\sigma_j \sigma_k = I = \sigma_0$) and $\epsilon_{jkl} = 0$ for all $l$. If $j$ and $k$ are different, note that $\sigma_j \sigma_k = -\sigma_k \sigma_j$.
            \begin{equation*}
